...
const Header = () => {
    ...
    return (
        <>
            <header
                className={`${openMobileMenu ? 'navbar-active' : ''}${size.width <= 600 ? ' position-static' : ''}`}>
                <div className='header-inner'>
                    <div className={`d-flex flex-column header-main${size.width <= 600 ? ' fixed' : ''} container`}>
                        <div className='header-main-inner '>
                            <div className='d-flex flex-items-center w-100'>
                                <Link to='/' className='header-brand'>
                                    <img src={logo} className='user-select-none user-drag-none'  alt='Kadabra'/>
                                </Link>
                                {size.width > 600 &&
                                <form className={location.pathname === '/' ? 'home-form-search' : undefined}
                                      onSubmit={handleSubmit(onSubmit)}>
                                    <Controller
                                        render={({field, fieldState: {error}}) =>
                                            <Input type='search' noShadow placeholder={t("searchProducts")} {...field}>
                                                <button>
                            ...
                            <div className='header-actions'>
                                <ul className='d-flex flex-row flex-items-center'>
                                    ...
                                    <li className='mobileMenu' onClick={() => {
                    ...
                    <div className='mobileMenuNav container'>
                        {login ?
                            ...
                            <ul>
                                ...
                                <li className='mb-0'>{t("language")} <span>Русский</span></li>
                            </ul>
                        }

...
function SelectSeparator({
    ...
    return (
        <SelectPrimitive.Separator
            ...
            className={clsx("bg-border -mx-1 my-1 h-px pointer-events-none", className)}
            {...props}
        />
    )
}
...
function SelectScrollUpButton({
    ...
    return (
        <SelectPrimitive.ScrollUpButton
            ...
            className={clsx("bg-popover z-10 flex cursor-default items-center justify-center py-1 [&_svg:not([class*='size-'])]:size-4", className)}
            {...props}
        >
            <ChevronUpIcon
            />

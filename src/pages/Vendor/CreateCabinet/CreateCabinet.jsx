    ...
    return (
        <div>
            ...
            <div className="cabinetBanner">
                {banner ? <div className='bannerCabinet'><img src={banner} alt="Banner"/>
                    <div className='changeBanner'><h3>Замените изображения баннера</h3>
                ...
                </div> : <div className='changeBanner'><h3>Замените изображения баннера</h3>
                    <p>Оптимальные размеры 3200 x 410px</p>
                    <Upload {...uploadBanner}>
                        <button className='pinkBtn'>Изменить</button>
                    </Upload>
            ...
            <div className="container">
                <div className='createCabinetPage mt-70px'>
                    <h2 className='bold-48px color-dark-blue'>Создание личного кабинета</h2>
                    <div className='profile_data mt-30px'>
                        <div className='d-flex flex-column flex-items-center avatar-wrapper'>
                            <Avatar
                                ...
                                src={fileImg ? <img src={fileImg} alt="Avatar"/> :
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="forms">
                            <div className="name">
                                <Controller
                                    render={({field, fieldState: {error}}) =>
                                        <Input type='text' noShadow borderRadius='2' error={error} {...field}
                                               className='input'
                                               label='Название магазина или компании:' placeholder='CompanyName.uz'
                                        />
                                    }
                                    name={'title'}
                                    control={control}
                                ...
                                <Controller
                                    render={({field, fieldState: {error}}) =>
                                        <Input type='tel' noShadow borderRadius='2' error={error} {...field}
                                               className='input'
                                               label='Дополнительный номер телефона:' placeholder='+998 (90) 123 45 67'
                                        />
                                    }
                                    name={'phone'}
                                    control={control}
                            ...
                            <div className="site">
                                <Controller
                                    render={({field, fieldState: {error}}) =>
                                        <Input type='text' noShadow borderRadius='2' error={error} {...field}
                                               className='input'
                                               label='Веб-сайт:' placeholder='www.companyname.uz'
                                        />
                                    }
                                    name={'website'}
                                    control={control}
                            ...
                            <div className="text">
                                <h4>Описание:</h4>
                                <textarea cols="30" rows="10" required={true} {...register("description")}/>
                                <Controller
                                    render={({field}) =>
                                        <Checkbox
                                            {...field}>
            ...
            >
                ...
                <p>Мы свяжемся с вами в течение 5 рабочих дней, после отправки заявки</p>
            </Modal>
            <Modal
                className='modalProfile'

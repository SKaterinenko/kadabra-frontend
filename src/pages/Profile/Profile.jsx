...
import {deleteProfile, getProfile, putPassword, putProfile, setPhotoProfile} from "../../redux/profileReducer";
...
const Profile = () => {
    ...
    const profileChangeState = useSelector(state => state.profilePage.profileChangeState)
    ...
    const onAccountChangeSubmit = (data) => {
        ...
        data.profile.dob = new Date(date.getTime() - (offset * 60 * 1000)).toISOString().split('T')[0];
            ...
            <div className="container">
                <div className='profilePage mt-70px'>
                    ...
                    <div className='profile_data mt-30px'>
                        ...
                        <div className="forms">
                            <div className='name'>
                                ...
                                <form onSubmit={handleAccountChangeSubmit(onAccountChangeSubmit)}>
                                    <Controller
                                        render={({field, fieldState: {error}}) =>
                                            <Input noShadow borderRadius='2' error={error} {...field}
                                                   label={t("forms:name")}/>
                                        }
                                        name={'first_name'}
                                        control={control}
                                    ...
                                    <Controller
                                        render={({field}) =>
                                            <PhoneNumberInput disabled borderRadius='3' {...field}
                                                              label={t("forms:phone")}/>
                                        }
                                        name={'username'}
                                        control={control}
                            ...
                            <div className='password'>
                                <form onSubmit={handlePasswordChangeSubmit(onPasswordChangeSubmit)}>
                                    ...
                                    <Controller
                                        render={({field, fieldState: {error}}) =>
                                            <Input noShadow borderRadius='2' error={error}  {...field}
                                                   label={t("profile:repeatPassword")} type='password'/>
                                        }
                                        name={'new_password2'}
                                        control={passwordControl}
                                        rules={{
                    ...
                    <section className='orders-history'>
                        <h2 className='bold-48px color-dark-blue'>{t("profile:history")}</h2>
                        <div className='d-flex flex-justify-center w-100'>
                            <svg width="592" height="546" viewBox="0 0 592 546" fill="none"

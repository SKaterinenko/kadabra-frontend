...
const SET_PASSWORD_RESET_STATE = 'kadabra/profileReducer/SET_PASSWORD_RESET_STATE'
const SET_PROFILE_CHANGE_STATE = 'kadabra/profileReducer/SET_PROFILE_CHANGE_STATE'
...
const profileReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case SET_STATUS:
            return {
                ...state,
                login: {...state.login, sent_request: action.status.sent_request, verified: action.status.verified}
            }
        case SET_TOKEN:
            return {
                ...state,
